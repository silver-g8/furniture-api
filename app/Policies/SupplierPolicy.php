...
class SupplierPolicy
{
    ...
    {
        // Allow admin, manager, and staff to view suppliers
    ...
    {
        // Allow admin, manager, and staff to view supplier details
        return $user->roles()->whereIn('name', ['admin', 'manager', 'staff'])->exists();
    }
    ...
    {
        // Only admin can restore suppliers
        return $user->roles()->where('name', 'admin')->exists();
    }
    ...
    {
        // Only admin can force delete suppliers
        return $user->roles()->where('name', 'admin')->exists();
    }
}
